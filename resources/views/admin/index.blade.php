 ...
 <!-- --------------------------------------------------------------------------------------------------------------- -->
 <!-- Grâce au yield present dans le fichier admin_master laravel comprendra qu'il faudra injecté ce  code dans la partie section
      Mais pour cela il faudrais utilisé le mot clé section pour que le systèm laravel puisse commprendre -->
 <!------------------------------------------------------------------------------------------------------------------ -->
 @section('admin')
 <!-- header area -->
     ...
     <nav class="sidebar-nav">
         <ul class="metismenu" id="menu1">
             <li class="single-nav-wrapper">
                 <a href="{{asset('index.html')}}" class="menu-item">
             ...
             <li class="single-nav-wrapper">
                 ...
                 <ul class="dashboard-menu">
                     <li><a href="{{asset('basic_table.html')}}">Basic table</a></li>
                     <li><a href="{{asset('data_table.html')}}">data table</a></li>
                 </ul>
             </li>
             <li class="single-nav-wrapper">
                 <a class="has-arrow menu-item" href="#" aria-expanded="false">
                 ...
                 <ul class="dashboard-menu">
                     <li><a href="{{asset('chart-float.html')}}">Float Chart</a></li>
                     <li><a href="{{asset('chart-float.html')}}">Float Chart</a></li>
                     <li><a href="{{asset('chart-float.html')}}">Float Chart</a></li>
                 </ul>
             </li>
             <li class="single-nav-wrapper">
                 ...
                 <ul class="dashboard-menu">
                     ...
                     <li><a href="{{asset('button.html')}}">Buttons</a></li>
                     <li><a href="{{asset('notification.html')}}">Notification</a></li>
                     <li><a href="{{asset('panels.html')}}">Panels</a></li>
                     <li><a href="{{asset('tabs.html')}}">Tab</a></li>
                     <li><a href="{{asset('modals.html')}}">Modals</a></li>
                     <li><a href="{{asset('progressbars.html')}}">Progressber</a></li>
                     <li><a href="{{asset('list.html')}}">List View</a></li>
                     <li><a href="{{asset('icheck_toggle_pagination.html')}}">iCheck, Toggle</a></li>
                     <li><a href="{{asset('label-badge-alert.html')}}">labels, Badges</a></li>
                     <li><a href="{{asset('treeview.html')}}">Tree View</a></li>
                 </ul>
             </li>
             <li class="single-nav-wrapper">
                 <a class="has-arrow menu-item" href="#" aria-expanded="false">
             ...
             <li class="single-nav-wrapper">
                 ...
                 <ul class="dashboard-menu">
                     ...
                     <li><a href="{{asset('registration.html')}}">Register</a></li>
                     <li><a href="{{asset('screen_lock.html')}}">screen lock</a></li>
                     <li><a href="{{asset('forget.html')}}">forget Password</a></li>
                 </ul>
             </li>
             <li class="single-nav-wrapper">
             ...
             <li class="single-nav-wrapper">
                 <a href="{{asset('blank_page.html')}}" class="menu-item">
